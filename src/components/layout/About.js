        ...
        <div className={styles.about}>
            ...
            <section className={styles["about__category"]}>
                ...
                <div className={styles["about__category--contents"]}>
                    ...
                    <p>
                        &nbsp;&nbsp;&nbsp;웹 퍼블리셔로 재직했던 경험을 통해 <strong className={styles['font_accent']}>시멘틱 태그를
                        사용</strong>한 마크업 작성, css 선택자를 활용한 **반응형
                        작업에 능숙**하며, javascript와 jQuery, 그리고 기타
                        라이브러리를 사용해 여러 이벤트를 구현했습니다.
                        퍼블리셔와 프론트엔드 역할을 맡아 현재 운영 중인 2개의
                        사이트 프로젝트에 참여하였고, 이를 계기로 프론트엔드
                        개발에 흥미가 생겨 부트캠프에 지원하게 되었습니다.<br />
                         프론트엔드 부트캠프에서는 React 를 중점적으로
                        공부했으며, 2개의 백엔드, 프론트엔드 협업 프로젝트를
                        완료하고 과정을 수료했습니다. 프로젝트를 진행하면서 현업
                        경험을 살려 **Github 이슈와 Pull Request를 적극 활용해
                        프로젝트를 관리**하였고, 원활한 코드 리뷰를 할 수 있도록
                        가독성 향상을 위해 **주석 작성**에 힘썼습니다. 메인
                        프로젝트에서 JWT 중복 발급 이슈가 있었는데, 이를
                        해결하기 위해 만료 시간 체크 후 재발급 요청을 하고
                        토큰을 쿠키에 저장 방식에서 401 에러 체크 후 재발급
                        요청, 로컬스토리지에 저장하는 방식으로 변경했습니다.
                        그리고 여러 화면에서 중복으로 사용되는 체크박스와 라디오
                        버튼, 알림창 같은 경우 **컴포넌트화를 통해 재사용성을
                        높이**고자 하였고, **사용자 맞춤 컨텐츠 노출 기능**을
                        작업했습니다. 또한 웹 퍼블리셔였던 경험을 살려 **피그마
                        작업을 리드**해 반응형 웹 구현을 수월하게 만들었습니다.<br />
                         현재 NEXT.JS를 공부하며 더 나은 개발자로 성장하기 위해
                        노력하고 있습니다. 웹 퍼블리셔였던 경험과 부트캠프에서
                        취득한 지식을 바탕으로 사용자의 관점에서 더 나은 사용자
                        경험를 고민하는 프론트엔드 개발자가 되겠습니다.
                    </p>
                    {/* <p>
